...
class WKPlainToolbarTableViewCell: UITableViewCell {
    
    lazy var componentView: UIView = {
        let view = UINib(nibName: String(describing: WKPlainToolbarView.self), bundle: Bundle.module).instantiate(withOwner: nil).first as! UIView
