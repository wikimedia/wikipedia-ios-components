...
class WKSimpleSelectionTableViewCell: UITableViewCell {
    
    private lazy var componentView: WKSimpleSelectionView = {
       let view = WKSimpleSelectionView()
    ...
    func configure(configuration: WKSimpleSelectionView.Configuration) {
