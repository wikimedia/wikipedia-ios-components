...
enum WKIcon {
    ...
    static let indentDecrease = UIImage(named: "editor/decrease-indent", in: .module, with: nil)
    static let indentIncrease = UIImage(named: "editor/increase-indent", in: .module, with: nil)
    static let italics = UIImage(named: "editor/italic", in: .module, with: nil)
